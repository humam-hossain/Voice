...
- [x] 03-02: Verify Wayland primary selection text capture and audio playback
...
- [x] 04-01: Document and configure Hyprland keybindings in `hyprland.conf`

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 04-02: Verify background recording daemon lifecycle and signal handling
