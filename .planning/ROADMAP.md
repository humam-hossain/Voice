...
- [ ] **Phase 1: Environment & Audio Subsystem** - Setup Python 3.12 via `uv` and verify PortAudio/PipeWire audio capture
...
Plans:
- [ ] 01-01: Create Python 3.12 virtual environment using `uv` and install core dependencies
- [ ] 01-02: Test and verify PortAudio audio capture and playback over PipeWire
...
|-------|----------------|--------|-----------|
| 1. Environment & Audio Subsystem | 0/2 | Not started | - |
